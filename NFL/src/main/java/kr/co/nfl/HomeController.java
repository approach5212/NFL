...
import kr.co.nfl.quarterback.domain.QuarterbackReport;
...
public class HomeController {
	...
	public String fileview(HttpServletRequest request, HttpServletResponse response) {
		quarterbackService.fileview(request, response);
		return "fileview";
	}
	...
	@RequestMapping(value = "quarterback.xls", method = RequestMethod.GET)
	public String excel(HttpServletRequest request, HttpServletResponse response, Model model) {
		// Quarterback 테이블의 데이터를 전부 읽어오는 서비스를 호출
	...
	@RequestMapping(value = "quarterback.pdf", method = RequestMethod.GET)
	...
	// json 출력을 위한 메소드
	@RequestMapping(value = "quarterback.json", method = RequestMethod.GET)
	...
	// xml 출력을 위한 메소드
	@RequestMapping(value = "quarterback.xml", method = RequestMethod.GET)
	public String xml(HttpServletRequest request, HttpServletResponse response, Model model) {
		// Quaterback 테이블의 데이터를 전부 읽어오는 서비스를 호출
		quarterbackService.allquarterback(request, response);
		List<Quarterback> list = (List<Quarterback>) request.getAttribute("list");
		QuarterbackReport quarterbackReport = new QuarterbackReport();
		quarterbackReport.setList(list);
		// Model에 데이터 저장
		model.addAttribute("list", quarterbackReport);
		// 출력할 뷰를 결정
		return "quarterbackxml";
	}
